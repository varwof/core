...
| [性能工程工作日志](zh/performance-worklog-2026-08-27.md) | 前置工程记录 §1–§4：bench 工具变更、argon2 根因、引擎模式三后端对比（PG/MySQL/SQLite）、DA nonce 批量写、User/Token 内存索引、MySQL 写管线崩溃根因（R12）、瓶颈 prof + 锁分片（R4/R13） |
